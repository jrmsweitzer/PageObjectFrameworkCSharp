...
namespace PageObjectFramework.Tests
{
    ...
    public class Presentation : PageObjectTestBase
    {
        ...
        public void MainPresentation()
        {
            ...
            email
                .LogInWithCredentials(@"catalystsolves\jsweitzer", "password")
                .ComposeNewEmail("jsweitzer@catalystitservices.com",
                    "Selenium PageObject Framework Source Code with C#",
                    "Check out this neat Source Code! It's an entire framework just for Selenium," +
